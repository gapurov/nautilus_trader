...
@typing.final
class BybitOptionCollateralUnavailable:
    def __init__(self, margin_mode: BybitMarginMode) -> None: ...
    @property
    def margin_mode(self) -> BybitMarginMode: ...
    @property
    def missing_authoritative_inputs(self) -> list[str]: ...
    @property
    def reason(self) -> str: ...
...
class BybitWebSocketClient:
    ...
    def connect(
        self, loop_: typing.Any, callback: typing.Any, margin_mode: BybitMarginMode | None = None
    ) -> typing.Any: ...
